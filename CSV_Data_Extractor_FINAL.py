                ...
                for col in columns:
                    if col in data:
                        ...
                        if category == 'Due date':
                            writer.writerow([col, data[col], "", "", stage])
                        else:
                            writer.writerow([col, "", data[col], "", stage])
                        
                        # Collect notes for this task
...
def main():
    ...
    output_dir = r"C:\Users\tomlo\OneDrive\Documents\Personal\Work\The Copper Mark\Extracted_1600"
